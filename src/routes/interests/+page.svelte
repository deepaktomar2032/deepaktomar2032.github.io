<script>
  ...
  import { interestsDescription } from '$lib/data/meta'
...
<svelte:head>
  <meta name="description" content={interestsDescription} />
</svelte:head>
            ...
            <article class="timeline-item">
              ...
              <div class="timeline-body">
                ...
                <div class="content">
                  ...
                  {#if interest.link}
                    <a class="interest-link" href={interest.link.href}>{interest.link.label}</a>
                  {/if}
                </div>
              </div>
            </article>
