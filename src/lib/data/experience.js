...
export const profile = `Senior Full-Stack Engineer (Backend-Focused) with ${yearsOfExperience}+ years of experience building scalable systems used at enterprise 
and consumer scale. Strong in system design, APIs, real-time features, and developer infrastructure. Experienced across aviation, gaming, and enterprise software, 
with a focus on reliability, performance, and long-term maintainability.`

export const description = `Over the past ${yearsOfExperience}+ years, my work has spanned security, 
casino gambling, social gaming, healthcare, and aviation - from early ideas to production systems.`
...
export const entries = [
  {
    ...
    description: `Leading backend architecture for enterprise workforce management software used by major international airlines. Designed core infrastructure, 
    real-time collaboration features, and system observability, while mentoring engineers and collaborating closely with architects and product leadership.`,
    tags: [
  ...
  },
  {
    ...
    description: `Built and scaled backend systems for high-traffic web gaming platforms distributed through global publishers. 
    Delivered revenue-impacting features, improved performance, and reduced operational overhead across multiple products.`,
    tags: [
      { color: `primary`, text: `TypeScript` },
  ...
  },
  {
    ...
    description: `Worked on core backend systems for large-scale gaming platforms, focusing on performance, security, 
    and scalable architecture. Mentored junior developers and contributed to improving system reliability.`,
    tags: [
      { color: `primary`, text: `TypeScript` },
  ...
  },
  {
    ...
    description: `Developed and maintained web and mobile applications used by millions of users worldwide. 
    Contributed to core product development, system migrations, and delivery pipeline improvements.`,
    tags: [
      { color: `primary`, text: `Typescript` },
      { color: `primary`, text: `Javascript` },
  ...
  },
  {
    ...
    description: `Researched real-world security vulnerabilities and attack patterns, contributed to internal security 
    training material, and built a web-based CTF application for practicing web application penetration testing.`,
    tags: [
